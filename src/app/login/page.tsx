                ...
                <form onSubmit={handleResetSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 py-3 bg-white text-slate-600 rounded-xl font-semibold border border-slate-200 hover:bg-slate-50 transition-all cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      disabled={resetLoading}
                      className="flex-1 py-3 bg-gradient-to-r from-primary-500 to-cyan-400 text-white rounded-xl font-semibold shadow-md hover:shadow-lg transition-all cursor-pointer border-none disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                      {resetLoading ? (
